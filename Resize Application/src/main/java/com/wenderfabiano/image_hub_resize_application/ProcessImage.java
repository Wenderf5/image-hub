package com.wenderfabiano.image_hub_resize_application;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.wenderfabiano.image_hub_resize_application.DTOs.Message;
import com.wenderfabiano.image_hub_resize_application.dataBase.enities.ImagesEntity;
import com.wenderfabiano.image_hub_resize_application.dataBase.repositories.ImagesRepository;
import com.wenderfabiano.image_hub_resize_application.exceptions.*;
...
public class ProcessImage {
    ...
    public void process(byte[] message) {
        ...
        try {
            ...
            changeRedisStatus("resize:" + id, "completed", Duration.ofMinutes(5));
        } catch (Exception e) {
            changeRedisStatus("resize:" + id, "failed", Duration.ofMinutes(5));
        }
    }
